...
@testset "compute fnn MPC: linear, non linear and milp" begin
    ...
    C_fnn_linear.computation_results.e_x
    ...
    C_fnn_nl.computation_results.e_x
    ...
    C_fnn_milp.computation_results.e_x
    C_fnn_milp.computation_results.e_u
...
@testset "compute resnet MPC: linear, non linear and milp" begin
    ...
    C_resnet_linear.computation_results.e_x
    ...
    C_resnet_nl.computation_results.e_x
    ...
    C_resnet_milp.computation_results.e_x
    C_resnet_milp.computation_results.e_u
    ...
    @test C_resnet_linear.computation_results.e_x ≈ C_resnet_milp.computation_results.e_x atol =
        0.5
    @test C_resnet_linear.computation_results.e_u[:, 1] ≈
          C_resnet_nl.computation_results.e_u[:, 1] atol = 1
    @test C_resnet_linear.computation_results.e_u[:, 1] ≈
          C_resnet_milp.computation_results.e_u[:, 1] atol = 1

end

@testset "compute densenet MPC: linear, non linear and milp" begin
    ...
    C_densenet_linear.computation_results.e_x
    ...
    C_densenet_nl.computation_results.e_x
    ...
    C_densenet_milp.computation_results.e_x
    C_densenet_milp.computation_results.e_u
...
@testset "compute polynet MPC: linear, non linear and milp" begin
    ...
    C_polynet_linear.computation_results.e_x
    ...
    C_polynet_nl.computation_results.e_x
...
@testset "compute icnn MPC: linear, non linear and milp" begin
    ...
    C_icnn_linear.computation_results.e_x
    ...
    C_icnn_nl.computation_results.e_x
    ...
    C_icnn_milp.computation_results.e_x
...
@testset "compute rbf MPC: linear, non linear" begin
    ...
    C_rbf_linear.computation_results.e_x
...
@testset "compute linear model MPC: linear" begin
